...
I designed and implemented a multi-platform cybersecurity homelab to simulate real-world Enterprise environments for practicing penetration testing, Network defense, and Active Directory management for my course Penetration Testing CY321 at GIKI. I am building this homelab to stimulate both Offensive and Defensive Security
...
- **Vulnerability Report**: Will upload that in next phase
- **Penetration Test**: Will upload that in next phase
- **Active Directory Enumeration**: Will upload that in next phase
- **Suricata Alerts**: Will upload that in next phase

---

## Future Enhancements
I will further enhance it to:
